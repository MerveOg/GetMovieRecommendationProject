...
public class TargetUser<T extends Comparable> extends javax.swing.JFrame {
    ...
    private static BufferedReader getBufferedReader(String fileName) {
        return new BufferedReader(new InputStreamReader(Objects.requireNonNull(TargetUser.class.getResourceAsStream(fileName))));
    }
    ...
    public void populateComboBoxFromCSV(String csvFilePath) {
        try (BufferedReader reader = getBufferedReader(csvFilePath)) {
            String line;
    ...
    private void initComponents() {
        ...
        recommendButton = new MyButton();
        backkButton = new MyButton();
    ...
    private MyButton recommendButton;
    private MyButton recommentButton1;
